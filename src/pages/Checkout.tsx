...
const Checkout = () => {
  ...
  const cartItems = [
    ...
    { name: "Öhlins TTX Shock Absorber", quantity: 1, price: 1599 },
  ];

  const subtotal = cartItems.reduce((sum, item) => sum + item.price * item.quantity, 0);
  const membershipDiscount = subtotal * 0.05;
  const shipping = 50;
  const total = subtotal - membershipDiscount + shipping;
              ...
              <Card className="sticky top-24">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 pb-4 border-b">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Membership Discount (5%)</span>
                      <span className="font-medium text-primary">-${membershipDiscount.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
